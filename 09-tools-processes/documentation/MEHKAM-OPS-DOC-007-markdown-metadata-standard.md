...
This document defines the official metadata header format for all Markdown documentation created inside Mehkam Holding and its subsidiary companies.
...
- Must follow Mehkam naming convention.
...
Defines which Mehkam company owns the document.
...
The Mehkam Markdown Metadata Header Standard ensures every document has a consistent identity, ownership model, and lifecycle tracking system.

All Mehkam Holding companies must follow this metadata standard for every Markdown document.
