...
This document defines the official versioning system for all documentation created inside Mehkam Holding and its subsidiary companies.
...
All Mehkam documentation must follow semantic versioning principles.

# 1. Version Format

Mehkam uses the following version format:
...
Versioning ensures that every Mehkam document remains traceable, reliable, and maintainable throughout its lifecycle.

All Mehkam Holding documents and subsidiary company documents must follow this versioning standard.
