...
This document defines the official structure for all Markdown documentation created inside Mehkam Holding and its subsidiary companies.
...
All Mehkam documentation must follow this structure:
...
<div align="center">
  <img
    src="../../04-brand/assets/logo/mehkam-symbol.svg"
    alt="Mehkam Logo"
    width="150"
  />
</div>
...
Every official Mehkam documentation should contain a Final Statement.
...
Mehkam documentation uses the following heading hierarchy:
...
Custom document structures require approval from Mehkam Documentation Team.
...
The Mehkam Markdown Document Structure Standard ensures every document across Mehkam Holding follows a unified, scalable, and professional structure.

This standard applies to all current and future Mehkam companies.
